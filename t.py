...
# r = obj_searchall()
# print(r)
# for idx, row in enumerate(r["demo - 副本"]["1"]["placeholders"]):
#     print(idx,row)
# refresh_table()
...
def output_pptx(aimodel_res,pptx_demo):
    ...
    # print(pptx_demo)
    # print(model_res1)
    # aimodel_res = json.dumps(json.loads(model_res1), ensure_ascii=False, indent=2)
    # print(aimodel_res)
    filename = os.path.splitext(os.path.basename(os.path.normpath(pptx_demo)))[0]
    ...
    # {'章节主页': {'name': '章节主页', 'type': '章节主页', 'descript': '', 'first_title1': '标题 1', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 11', 'context2': '', 'pic1': '', 'pic2': '', 'page': '1'}, '目录页': {'name': '目录页', 'type': '目录页', 'descript': '', 'first_title1': '', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 11', 'context2': '', 'pic1': '', 'pic2': '', 'page': '2'}, '学习要求': {'name': '学习要求', 'type': '学习要求', 'descript': '', 'first_title1': '', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 7', 'context2': '', 'pic1': '', 'pic2': '', 'page': '3'}, '重难点': {'name': '重难点', 'type': '重难点', 'descript': '', 'first_title1': '', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '内容占位符 5', 'context2': '', 'pic1': '', 'pic2': '', 'page': '4'}, '节标题页': {'name': '节标题页', 'type': '节标题页', 'descript': '', 'first_title1': '', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 7', 'context2': '', 'pic1': '', 'pic2': '', 'page': '5'}, '普通正文': {'name': '普通正文', 'type': '普通正文', 'descript': '', 'first_title1': '', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 3', 'context2': '', 'pic1': '', 'pic2': '', 'page': '6'}, '小标题正文': {'name': '小标题正文', 'type': '小标题正文', 'descript': '', 'first_title1': '标题 1', 'first_title2': '', 'second_title1': '文本框 10', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 4', 'context2': '', 'pic1': '', 'pic2': '', 'page': '7'}, '图片正文': {'name': '图片正文', 'type': '图片正文', 'descript': '', 'first_title1': '标题 1', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 9', 'context2': '', 'pic1': '图片占位符 20', 'pic2': '', 'page': '8'}, '小标题图片正文': {'name': '小标题图片正文', 'type': '小标题图片正文', 'descript': '', 'first_title1': '标题 1', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 9', 'context2': '', 'pic1': '图片占位符 20', 'pic2': '', 'page': '9'}, '例题': {'name': '例题', 'type': '例题', 'descript': '', 'first_title1': '标题 1', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 10', 'context2': '', 'pic1': '', 'pic2': '', 'page': '10'}, '思维导图': {'name': '思维导图', 'type': '思维导图', 'descript': '', 'first_title1': '标题 1', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '图片占位符 20', 'context2': '', 'pic1': '', 'pic2': '', 'page': '11'}, '': {'name': '', 'main_title': '标题 1', 'small_title': '', 'context': '文本框 7', 'pic': '', 'type': '', 'descript': '', 'first_title1': '', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '', 'context2': '', 'pic1': '', 'pic2': '', 'page': '12'}, '尾页': {'name': '尾页', 'type': '尾页', 'descript': '', 'first_title1': '标题 1', 'first_title2': '', 'second_title1': '', 'second_title2': '', 'third_title1': '', 'third_title2': '', 'context1': '文本框 7', 'context2': '', 'pic1': '', 'pic2': '', 'page': '13'}}
    format_pptx_json = {j["type"]: {**j, "page": i} for i,j in pptx_json.items()}
    # print(model_res1)
    # print(pptx_json)
    prs = Presentation(pptx_demo)
    # print(prs.slides[0],type(prs.slides))
    for ri,rj in aimodel_res.items():
        if not (rj["type"] in format_pptx_json.keys()):
            continue
        ...
        template_slide = prs.slides[page_num]
